...
const PAYROLL_EXPORT_MAX_DAYS = 31;

export class PayrollQueryDto {
  @ApiProperty({
    example: '2026-05-01',
    description: 'Date de début de la période de paie, au format YYYY-MM-DD.',
  })
  ...
  @ApiProperty({
    example: '2026-05-31',
    description:
      'Date de fin de la période de paie, au format YYYY-MM-DD. Doit être >= from et couvrir au maximum 31 jours.',
  })
  @Transform(({ value }) => trimString(value))
  ...
  @IsValidDateRange('from', PAYROLL_EXPORT_MAX_DAYS, {
